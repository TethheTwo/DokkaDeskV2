...
import { Trash2, ZoomIn, X, UploadCloud } from "lucide-react";
...
export function AvatarCard() {
  ...
  return (
    <div className="bg-card rounded-md shadow-sm border border-border p-6">
      ...
      <p className="text-xs text-[#005da9] mt-1">
      ...
      <div className="mt-5 flex items-center gap-5">
        <button
          ...
          className="relative h-24 w-24 rounded-full overflow-hidden border border-border bg-[#005da9] text-white text-3xl font-semibold flex items-center justify-center group"
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            disabled={busy}
            className="inline-flex items-center gap-1.5 h-9 px-3 rounded-md bg-[#005da9] text-white text-xs font-semibold hover:opacity-90 disabled:opacity-60"
          >
