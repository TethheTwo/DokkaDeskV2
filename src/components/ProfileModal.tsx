      ...
      >
        ...
        <div className="px-6 py-5 flex items-center gap-4 border-b border-border">
          <div className="relative shrink-0">
            <div className="h-16 w-16 rounded-full overflow-hidden flex items-center justify-center bg-[#005da9] text-white text-2xl font-semibold">
              {avatarUrl ? (
            ...
            <button
              ...
              disabled={uploading}
              className="absolute -bottom-1 -right-1 h-6 w-6 rounded-full bg-[#005da9] text-white flex items-center justify-center shadow-sm hover:opacity-90 disabled:opacity-50"
              title="Cambiar foto"
            >
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1 flex gap-2">
              <button
                onClick={() => fileRef.current?.click()}
                disabled={uploading}
                className="text-xs text-[#005da9] hover:underline disabled:opacity-50"
              >
