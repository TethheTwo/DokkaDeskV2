...
function ProfileCard() {
  ...
  return (
    <div className="bg-card rounded-md shadow-sm border border-[#e2e8f0] p-6">
      ...
      <form onSubmit={handleSave} className="mt-5 space-y-4">
        <Field label="Nombre completo">
          <input
            ...
            className="w-full h-10 rounded-md border border-input bg-transparent px-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#005da9]"
          />
        </Field>
        ...
        <div className="pt-2">
          <button
            type="submit"
            className="inline-flex items-center h-9 px-5 rounded-md bg-[#005da9] text-white text-xs font-semibold tracking-wider uppercase hover:opacity-90"
          >
            Guardar
          </button>
        </div>
