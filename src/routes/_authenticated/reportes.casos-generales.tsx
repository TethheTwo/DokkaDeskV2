...
function CGPage() {
  ...
  const submit = async () => {
    const required = [
      "fecha_solicitud", "fecha_siniestro", "danos_personales", "asegurado",
        ...
        <div className="bg-white p-4 rounded-xl border border-[#e2e8f0] shadow-sm flex flex-col md:flex-row gap-4 items-center">
          <div className="relative flex-grow w-full">
            ...
            <input
              ...
              placeholder="Filtrar por Ticket, Asegurado o Carnet..."
            />
          </div>
          ...
          <div className="overflow-x-auto">
            ...
            <thead>
                <tr className="bg-[#f2f3f6] border-b border-[#e2e8f0]">
                  ...
                  <th className="px-6 py-4 text-label-caps text-[#414752]">Asegurado</th>
              ...
              {filtered.length === 0 ? (
                ...
                paged.map((r) => {
                  ...
                  return (
                    ...
                    >
                      <td className="px-6 py-4"><span className="font-body-bold text-[#005da9]">{formatCode("CG", r.nro)}</span></td>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-col">
                          <span className="font-body-medium text-[#191c1e]">{r.asegurado ?? "-"}</span>
                          <span className="text-[#64748b] text-[13px]">Sol.: {r.solicitante ?? "-"}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 font-mono text-body-medium text-[#575f67]">-</td>
                      <td className="px-6 py-4">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 overflow-y-auto" onClick={(e) => { if (e.target === e.currentTarget) setOpen(false); }}>
          <div className="bg-white w-full max-w-6xl rounded-xl shadow-2xl flex flex-col my-8">
            <div className="px-6 py-4 border-b border-[#e2e8f0] flex items-center justify-between bg-[#f2f3f6] rounded-t-xl">
              <h2 className="text-headline-sm text-[#191c1e]">Nuevo registro — Casos Generales</h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-8">
                <div>
                  <div className="flex items-center gap-2 mb-4 pb-2 border-b border-[#e2e8f0]">
                    ...
                    <h3 className="text-body-bold text-[#191c1e] uppercase tracking-wider">Información del siniestro</h3>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <Field label="Daños personales" error={errors.danos_personales}>
                      <input value={form.danos_personales} onChange={(e) => set("danos_personales", e.target.value)} className="form-input" placeholder="Especifique daños" />
                    </Field>
                    <Field label="Asegurado" error={errors.asegurado}>
                      <input value={form.asegurado} onChange={(e) => set("asegurado", e.target.value)} className="form-input" placeholder="Nombre del asegurado" />
                    </Field>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    <Field label="Celular" error={errors.celular}>
                      <input value={form.celular} onChange={(e) => set("celular", e.target.value)} className="form-input" placeholder="7000-0000" />
                    </Field>
                    ...
                    <Field label="Dirección" full error={errors.direccion}>
                      <input value={form.direccion} onChange={(e) => set("direccion", e.target.value)} className="form-input" />
                    </Field>
                  </div>
                </div>
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <Field label="Celular del ejecutivo">
                      <input value={form.ejecutivo_celular} onChange={(e) => setForm({...form, ejecutivo_celular: e.target.value})} className="form-input" />
                    </Field>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <Field label="Descripción" error={errors.descripcion}>
                      <textarea value={form.descripcion} onChange={(e) => set("descripcion", e.target.value)} className="form-input" style={{height:"auto",padding:"0.5rem 0.75rem"}} rows={3} placeholder="Detalles del caso..." />
                    </Field>
